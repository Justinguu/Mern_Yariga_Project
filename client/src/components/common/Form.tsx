      ...
      <Typography fontSize={25} fontWeight={700} color="#11142d">
        ...
        >
          <FormControl>
            ...
            color="info"
            variant="outlined"
            {...register('title', {required: true})} // passing title of textfield
            />
          </FormControl>
          ...
          <Stack direction="row" gap={4}>
            ...
            type="number"
            variant="outlined"
            {...register('price', {required: true})} // passing title of textfield
            />
          </FormControl>
             </Stack>
             <FormControl>
            ...
            color="info"
            variant="outlined"
            {...register('location', {required: true})} // passing title of textfield
            />
          </FormControl>
