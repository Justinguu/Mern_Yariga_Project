...
const AllProperties = () => {
  ...
  const currentPrice = sorter.find((item) => item.field === 'price')?.order; // give us the current order of the price property
...
// currentFilterValues filters by title
      ...
      {allProperties.length > 0 && (
        <Box display="flex" gap={2} mt={3} flexWrap="wrap">
          ...
          <Select
            ...
            defaultValue={5}
            value=""
            onChange={(e) => setPageSize(e.target.value ? Number(e.target.value) : 5)}
          >
