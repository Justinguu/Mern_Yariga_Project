...
const getAllProperties = async (req, res) => {
    ...
    try {
        ...
        .limit(_end)
        .skip(_start)
        .sort({ [_sort]: _order });  // ascending or descending

        res.header("x-total-count", count);
        res.header("Access-Control-Expose-Headers", "x-total-count"); // expose header to frontend to know how many count of total rescourses
